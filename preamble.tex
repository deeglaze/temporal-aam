...
\newcommand*{\pmsmq}{q}
\newcommand*{\pmsmqcur}{q_\mathit{cur}}
\newcommand*{\pmsmqlast}{q_\mathit{last}}
...
\newcommand*{\epshelp}{\mathit{translate}}
\newcommand*{\translateeps}{\mathit{translate}0}
\newcommand*{\translateclose}{\mathit{translate}1}
...
\newcommand*{\sstep}[3]{\tuple{\delta{}step}{#1,\,#2,\,#3}}
...
\newcommand*{\stwrap}[3]{{\tt wrap}(#1,\,{\tt ?}#2)\ #3}
\newcommand*{\stnot}[1]{\neg #1}
\newcommand*{\sddd}{{\tt ...}}
