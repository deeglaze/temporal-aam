...
\newcommand*{\iflong}[1]{}
\WithSuffix\newcommand\iflong*[2]{#2}
\newcommand*{\iftwocolumn}[2]{#2}

\newcommand{\dfm}{DFM}%\citeauthor{ianjohnson:dfm:icfp2011}~}
...
\newcommand*{\msendrec}{\pm}


\newcommand*{\mbindenv}{\gamma}
\newcommand*{\menvs}{\isset{\menv}}
...
\newcommand*{\mscon}{S}
\newcommand*{\mtcon}{T}
\newcommand*{\motcon}{T^\circ}
\newcommand*{\mtcons}{{\mathcal T}}
\newcommand*{\mname}{n}
\newcommand*{\mtoplevelname}{\ell}
\newcommand*{\mevent}{A}
\newcommand*{\mbevent}{B}
\newcommand*{\mconstant}{\mathit{cst}}
\newcommand*{\mfnpat}{f}
...
\newcommand*{\alias}{\mathit{alias}}
\newcommand*{\adhere}{\mathit{adhere}}
...
\newcommand*{\matches}{\mathit{m}}
\newcommand*{\nullable}{\nu}
\newcommand*{\flatempty}{\mu}
...
% Syntax
\newcommand*{\may}{{\tt may}}
\newcommand*{\must}{{\tt must}}
\newcommand*{\smay}[1]{\may(#1)}
\newcommand*{\smust}[1]{\must(#1)}

\newcommand*{\snlam}[3]{\lambda^{#1} #2.\ #3}
...
\newcommand*{\stblame}[2]{{\tt tblame}^{#1}_{#2}}
\newcommand*{\mcev}{\mathit{ac}}
\newcommand*{\scevdfm}[2]{\tuple{\mcev}{#1,#2}}
\newcommand*{\scev}[5]{\tuple*[^{#1}_{#2}]{\mcev}{#3,#4}{#5}}
%\newcommand*{\scall}[3]{\tuple*[^{#1}]{call}{#2}{#3}}
%\newcommand*{\sret}[3]{\tuple*[^{#1}]{ret}{#2}{#3}}
\newcommand*{\scall}[5]{\tuple*[^{#1}_{#2}]{call}{#3,#4}{#5}}
\newcommand*{\sret}[5]{\tuple*[^{#1}_{#2}]{ret}{#3,#4}{#5}}
...
\newcommand*{\denotetconbothe}[2]{B[\![ #1 ]\!]_{#2}}
...
% Notation
\newcommand*{\retof}[1]{\widehat{#1}}
\newcommand*{\many}[1]{\overline{#1}}
\newcommand*{\isset}[1]{\tilde{#1}}
...
\newcommand*{\derivee}[3]{\partial_{#1}^{#3}{#2}}
...
\newcommand*{\FunctionAction}{\mathit{FAction}}
\newcommand*{\BEvent}{\mathit{BEvent}}
\newcommand*{\VPat}{\mathit{TPattern}}
\newcommand*{\Constant}{\mathit{Constant}}
\newcommand*{\Constructors}{\mathit{Constructors}}
...
\newcommand*{\MEnv}{\mathit{MEnv}}
\newcommand*{\mmenv}{\mathit{D}}
