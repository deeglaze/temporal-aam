...
%
Through these methods, complete monitoring --- and its proof of correctness in an \emph{indy} semantics --- is preserved from the work of \citet{ianjohnson:dthf:complete}.