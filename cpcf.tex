...
&&\phantom{\text{where }} \mexp_{call} = \sapp{\mval_\lambda}{\sSMon{\mmlab^\prime}{k}{j}{\mtimeline}{\mscon_D}{\mval}} \\
&&\phantom{\text{where }} \mval_\lambda = \slam{\mvar}{\mexp} \in \msto(\maddr) \\
&&\phantom{\text{where }} \mTMons^\prime \in \sstep{\mTMons}{\mtimeline}{\scallev{\mmlab_\lambda}{\mval}}
