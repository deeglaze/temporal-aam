...
\\
    \denoteevent{\swrapev{\mtoplevelname}{\mvpat}}{\mtimeline}{\menv} &=
      \setbuild{\apwrapev{\mtoplevelname}{\mval}}{\labelis{\mval}{\mtoplevelname} \text{ and } \timelineis{\mval}{\mtimeline}}
    \\\text{where } \mval &= \mathit{ppat}(\mvpat, \menv)
\\
  ...
  \begin{mathpar}
    \infer{(\pmsmq, \mpat, \pmsmq') \in \delta \\
      \ensuremath{
           ...
           \end{array}}
}{\pmsmstate{\pmsmq, \mbindenv} \overset{\mdata}{\to}
