...
\name{tmon} \\
&&\text{where } \update{\mTMons}{\mtimeline}{\smachine} \\
&&\phantom{\text{where }} \smachine = \compile{\mtcon}{\mtimeline} \ne \bot \\
...
\sblame{j}{j}
\name{tmon-fail} \\
&&\text{where } \bot = \compile{\mtcon}{\mtimeline} \\
&&\phantom{\text{where }} \mtimeline = \salloc{\mstate} \\
&&\text{given } \mmlab = \toplevel 
...
&&\phantom{\text{where }} \mexp_{call} = \sapp{\mval_\lambda}{\sSMon{\mmlab^{\prime\prime}}{k}{j}{\mtimeline}{\mscon_D}{\mval}} \\
...
&&\phantom{\text{where }} \mmlab^\prime = \mmlab_\lambda
...
\name{return} \\
&&\text{where } \mTMons^\prime \in \sstep{\mTMons}{\mtimeline}{\sretev{\mmlab}{\mval}} \\
&&\phantom{\text{where }} \mmlab^\prime = \mmlab_{ret}
