  ...
  \begin{mathpar}
    \infer{(\pmsmq, \mpat, \pmsmq') \in \delta \\
      \ensuremath{
           ...
           \end{array}}
}{\pmsmstate{\pmsmq, \mbindenv} \pmsmstepd{\mdata}{\delta}
  \pmsmstate{\pmsmq', \mbindenv'}}
\\
    \infer{(\pmsmq, \mpat, \pmsmq') \in \delta \\
      \ensuremath{
           \begin{array}{l}
             \smay{\mbindenv'}  = \match(\mpat, \mdata, \mbindenv) \text{ or} \\
...
&&\text{where } \mTMons^\prime = \mTMons[\mtimeline \mapsto \compile{\mtcon}{\mtimeline}] \\
