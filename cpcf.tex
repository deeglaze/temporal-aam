...
\begin{lemma}
  $\mtrace \in \denotetcon{\mtcon}{\mtimeline}{\menv}$ iff $\exists \pmsmq \in F, \menv'$. $\pmsmstate{\pmsmqcur, \menv} \overset{\mtrace}{\underset{\delta}{\to}} \pmsmstate{\pmsmq, \menv'}$ is a well-formed trace (the function positions of matched events are all on $\mtimeline$) where $(\delta, F, \pmsmqlast, k') = \epshelp^\mtimeline(\mtcon, \pmsmqcur, k)$
\end{lemma}
\begin{proof}
...
\\ % Arrow monitor
\sSMon{k}{\mmlab}{j}{\mtimeline}{ \sarr{\mtoplevelname}{\mscon_D}{\mscon_R} }{\mval}
&\machstep&
\sown{\bclos{\mtoplevelname}{\mscon_D}{k}{j}{\mtimeline}{\mscon_R}{\mmlab}{\maddr}}{\mmlab} \\
...
\sblame{k}{j}
\\ % Blessed application
\sapp{ \sOwn{\bclos{\mtoplevelname}{\mscon_D}{k}{j}{\mtimeline}{\mscon_R}{\mmlab^{\prime\prime}}{\maddr}}{\mmlab} }{ \sOwn{\mval}{\mmlab} }
&\machstep&
%TODO: Should the timeline be different?
\mexp_{ret} \\
%TODO: Do we even need to explicitly deref here?
&&\text{where } \mexp_{ret} =
\sret{\mtoplevelname}{\mtimeline}{ \sSMon{k}{\mmlab^{\prime\prime}}{j}{\mtimeline}{\mscon_R}{\mexp_{call}} } \\
&&\phantom{\text{where }} \mexp_{call} =
\scall{\mtoplevelname}{\mtimeline}{ \sapp{\mval_\lambda}{\sSMon{\mmlab^{\prime\prime}}{k}{j}{\mtimeline}{\mscon_D}{\mval}} } \\
&&\phantom{\text{where }} \mval_\lambda = \slam{\mvar}{\mexp} = \msto(\maddr)
\\ % Call
\scall{\mtoplevelname}{\mtimeline}{\sOwn{\mval}{\mmlab}}
&\machstep&
\mval
\qquad\text{where } \mTMons^\prime = \sstep{\mTMons}{\mtimeline}{\scallev{\mtoplevelname}{\mval}}
\\ % Call fail
\ditto
&\machstep&
\sblame{\mmlab}{j}
\qquad\text{given } \bot = \sstep{\mTMons}{\mtimeline}{\scallev{\mtoplevelname}{\mval}}
\\ % Return
\sret{\mtoplevelname}{\mtimeline}{ \sOwn{\mval}{\mmlab} }
&\machstep&
\mval
\qquad\text{where } \mTMons^\prime = \sstep{\mTMons}{\mtimeline}{\sretev{\mtoplevelname}{\mval}}
\\ % Return fail
\ditto
&\machstep&
\sblame{\mtoplevelname}{\j}
\qquad\text{given } \bot = \sstep{\mTMons}{\mtimeline}{\sretev{\mtoplevelname}{\mval}}
\\ % Dereference
\maddr
&\machstep&
\mval
