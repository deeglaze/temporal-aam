...
&&\text{where } \mexp_{ret} =
\sret{\mname}{\mtimeline}{ \sSMon{k}{\mmlab^{\prime\prime}}{j}{\mtimeline}{\mscon_R}{\mexp_{call}} } \\
&&\phantom{\text{where }} \mexp_{call} =
\scall{\mname}{\mtimeline}{ \sapp{\mval_\lambda}{\sSMon{\mmlab^{\prime\prime}}{k}{j}{\mtimeline}{\mscon_D}{\mval}} } \\
&&\phantom{\text{where }} \mval_\lambda = \slam{\mvar}{\mexp} = \msto(\maddr)
\\ % Call
\scall{\mname}{\mtimeline}{\sOwn{\mval}{\mmlab}}
&\machstep&
\mval
\qquad\text{where } \mTMons^\prime = \sstep{\mTMons}{\mtimeline}{\scallev{\mname}{\mval}}
\\ % Call fail
\ditto
&\machstep&
\sblame{\mmlab}{j}
\qquad\text{given } \bot = \sstep{\mTMons}{\mtimeline}{\scallev{\mname}{\mval}}
\\ % Return
\sret{\mname}{\mtimeline}{ \sOwn{\mval}{\mmlab} }
&\machstep&
\mval
\qquad\text{where } \mTMons^\prime = \sstep{\mTMons}{\mtimeline}{\sretev{\mname}{\mval}}
\\ % Return fail
\ditto
&\machstep&
\sblame{\mname}{\j}
\qquad\text{given } \bot = \sstep{\mTMons}{\mtimeline}{\sretev{\mname}{\mval}}
\\ % Dereference
\maddr
&\machstep&
\mval
