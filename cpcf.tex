...
%
Disney, Flannagan and McCarthy's proposed a system of \emph{temporal higher-order contracts}~\citep{ianjohnson:DBLP:conf/icfp/DisneyFM11} (DFM) to provide a linguistic mechanism for describing temporal properties of behavioral values flowing through the program.
%
