...
%
We consider the fail contract $\bot$ as a macro for $\stOr{\setof{}}$; \dfm's universal contract $\sddd$ was intended to be interpreted greedily (though was not in the formal semantics), but greediness poses challenges to the derivative parsing approach we have taken, and leave the study of greediness to future work.
%
