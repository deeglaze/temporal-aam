...
%    \matches &: \Pattern \times \Qualified \times \Env \to \MatchResult \\
    ...
    \matches(\mpat, S, \menv) &= \Delta\setbuild{\matches(\mpat, \mdata, \menv)}{\mdata \in S} \\
    ...
    \delta \setof{t \ldots} &= \may \quad \text{otherwise}
...
%   \flatempty[_\menv](\stOr{\mtcon\ldots}) &= \bigwedge \flatempty[_\menv](\mtcon)\ldots \\
%   \flatempty[_\menv](\stAnd{\mtcon\ldots}) &= \bigvee \flatempty[_\menv](\mtcon)\ldots \\
